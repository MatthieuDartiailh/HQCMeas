# -*- coding: utf-8 -*-
# =============================================================================
# module : instruments/manager/test_forms.py
...
with enaml.imports():
    ...
    from hqc_meas.instruments.manager.profile_form import ProfileForm
    from hqc_meas.instruments.manager.profile_edition import (ProfileView,
                                                              ProfileDialog)
    from hqc_meas.instruments.manager.forms.base_forms import DummyForm
