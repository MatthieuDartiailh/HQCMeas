...
class AbstractConnectionForm(HasTraits):
    ...
    Views
    -----
    traits_view : used for static display in the instrument manager
    edit_view : used when the user request to edit an instrument profile
    new_view : used when the user creates a new instrument profile
